...
class PFLD_GhostNet_Slim_3D_Backbone(Module):
    def __init__(self, width_factor=1, input_size=112, landmark_number=98):
        super(PFLD_GhostNet_Slim_3D_Backbone, self).__init__()
...
class PFLD_GhostNet_Slim_3D_new(Module):
    def __init__(self, width_factor=1, input_size=112, landmark_number=98):
        super(PFLD_GhostNet_Slim_3D_new, self).__init__()

        self.backbone = PFLD_GhostNet_Slim_3D_Backbone(width_factor, input_size, landmark_number)
        ...
        self.fc = Linear(int(tmp.shape[1]), landmark_number * 2)
        self.fc_depth = Linear(int(tmp.shape[1]), landmark_number)
        self.fc_angle = Linear(int(tmp.shape[1]), 3)
